...
HD_PWD='F:/workspace/xilinx/timingtest/ccd_timing_test.runs/fifo_tx_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_tx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_tx.tcl

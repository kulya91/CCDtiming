...
HD_PWD='F:/workspace/xilinx/timingtest/ccd_timing_test.runs/MMCM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MMCM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MMCM.tcl
